...
def webhsh():
    ...
    print("\033[92m")
    os.system("     find " + main.getinstalldir() + "/WEB/CHEATSHEETS/ -type f")
    print("\033[90m")
    main.okwe()
#Tools
def Spaghetti():
    ...
    if os.path.exists('/usr/local/bin/Spaghetti'):
        main.prilogspc()
        os.system("git clone https://github.com/c0ll3cti0n/Spaghetti.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        if verbose in yes:
            ...
            verbose = ""
        main.prilogspc()
        os.system("cd  " + main.getinstalldir() + tool_dir + " && python2 spaghetti.py -u " + target + " -s " + scoption + crawler + ranagent + agent + proxy + verbose)
        main.okwe()
    else:
        main.prilogspc()
        print("\033[92m           " + Spaghetti.title + "\033[90m")
        ...
        os.system("echo python2 " + main.getinstalldir() + tool_dir + "/spaghetti.py >> /usr/local/bin/Spaghetti")
...
def BruteXSS():
    ...
    if os.path.exists('/usr/local/bin/BruteXSS'):
        main.prilogspc()
        os.system("git clone https://github.com/rajeshmajumdar/BruteXSS " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        print("\033[92m           " + BruteXSS.title + "\033[90m")
        main.spc()
        print("\033[92mCheatsheets that can help you with this :")
        main.spc()
        os.system("find " + main.getinstalldir() + "/WEB/CHEATSHEETS/ -type f | grep xss")
        print("\033[90m")
        main.spc()
        main.oktocont()
        os.system("BruteXSS")
        ...
        os.system("echo python2 " + main.getinstalldir() + tool_dir + "/brutexss.py >> /usr/local/bin/BruteXSS")
...
def Jdorker():
    ...
    if os.path.exists('/usr/local/bin/Jdorker'):
        main.prilogspc()
        os.system("git clone  https://github.com/04x/J-dorker.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo python2 " + main.getinstalldir() + tool_dir + "/priv8dorker.py >> /usr/local/bin/Jdorker")
...
def whatweb():
    ...
    if os.path.exists('/usr/local/bin/whatweb'):
        main.printlogo()
        os.system("git clone  https://github.com/urbanadventurer/WhatWeb " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        main.spc()
        ...
        target = input("Select a Target : ")
        main.prilogspc()
        os.system(main.getinstalldir() + tool_dir + "/whatweb " + target)
        main.okwe()
    else:
        main.prilogspc()
        print("\033[92m           " + whatweb.title + "\033[90m")
        ...
        main.prilogspc()
        print("\033[91mInstalling ...\033[0m.")
        os.system("cd " + main.getinstalldir() + tool_dir +" && gem install json && gem install rchardet")
        os.system("""echo "#!/bin/bash" > /usr/local/bin/whatweb""")
        os.system("""echo "#Dev : Sofiane Hamlaoui" >> /usr/local/bin/whatweb""")
        os.system("echo " + main.getinstalldir() + tool_dir + "/whatweb >> /usr/local/bin/whatweb")
...
def sqlmap():
    ...
    if os.path.exists('/usr/bin/sqlmap'):
        main.printlogo()
        os.system("git clone  https://github.com/sqlmapproject/sqlmap " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        main.spc()
        os.system("find " + main.getinstalldir() + "/WEB/CHEATSHEETS/ -type f | grep sqli")
        main.popp()
        ...
        os.system("echo python3 " + main.getinstalldir() + tool_dir + "/sqlmap.py >> /usr/local/bin/sqlmap")
...
def CMSmap():
    ...
    if os.path.exists('/usr/local/bin/CMSmap'):
        ...
        print("\033[91mDownloading ...\033[0m")
        main.spc()
        os.system("git clone https://github.com/Dionach/CMSmap.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        print("\033[92m           " + CMSmap.title + "\033[90m")
        main.spc()
        main.prilogspc()
        print("\033[91mInstalling ...\033[0m.")
        os.system("cd " + main.getinstalldir() + tool_dir + " && python3 setup.py install >/dev/null")
...
def droopescan():
    ...
    if os.path.exists('/usr/local/bin/droopescan'):
        main.prilogspc()
        os.system("git clone  https://github.com/droope/droopescan.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        main.prilogspc()
        print("\033[91mInstalling ...\033[0m.")
        os.system("cd " + main.getinstalldir() + tool_dir + " && pip install -r " + main.getinstalldir() + tool_dir + "/requirements.txt" + null)
...
def Optiva():
    ...
    if os.path.exists('/usr/local/bin/Optiva'):
        main.prilogspc()
        os.system("git clone  https://github.com/joker25000/Optiva-Framework " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        main.prilogspc()
        print("\033[91mInstalling ...\033[0m.")
        os.system("chmod +x " + main.getinstalldir() + tool_dir + "/installer.sh")
        os.system("cd " + main.getinstalldir() + tool_dir + " && sh installer.sh")
...
def V3n0M():
    ...
    if os.path.exists('/usr/local/bin/V3n0M'):
        main.prilogspc()
        os.system("git clone  https://github.com/v3n0m-Scanner/V3n0M-Scanner.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        main.prilogspc()
        print("\033[91mInstalling ...\033[0m.")
        os.system("python3 " + main.getinstalldir() + tool_dir + "/setup.py install" + null)
...
def Atscan():
    ...
    if os.path.exists('/usr/local/bin/Atscan'):
        main.prilogspc()
        os.system("git clone  https://github.com/AlisamTechnology/ATSCAN.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo perl " + main.getinstalldir() + tool_dir + "/atscan.pl >> /usr/local/bin/Atscan")
...
def WPSeku():
    ...
    if os.path.exists('/usr/local/bin/WPSeku'):
        main.prilogspc()
        os.system("git clone  https://github.com/m4ll0k/WPSeku.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo python3 " + main.getinstalldir() + tool_dir + "/wpseku.py >> /usr/local/bin/WPSeku")
...
def XSStrike():
    ...
    if os.path.exists('/usr/local/bin/XSStrike'):
        main.prilogspc()
        os.system("git clone  https://github.com/s0md3v/XSStrike.git " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo python3 " + main.getinstalldir() + tool_dir + "/xsstrike.py >> /usr/local/bin/XSStrike")
...
def Joomscan():
    ...
    if os.path.exists('/usr/local/bin/Joomscan'):
        main.prilogspc()
        os.system("git clone  https://github.com/rezasp/joomscan.git  " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo perl " + main.getinstalldir() + tool_dir + "/joomscan.pl >> /usr/local/bin/Joomscan")
...
def Dzjecter():
    ...
    if os.path.exists('/usr/local/bin/Dzjecter'):
        main.prilogspc()
        os.system("git clone https://github.com/joker25000/Dzjecter " + main.getinstalldir() + tool_dir + null)
        main.prilogspc()
        ...
        os.system("echo python2 " + main.getinstalldir() + tool_dir + "/Dzjecter.py >> /usr/local/bin/Dzjecter")
