...
function chkapt {
    ...
    if [ "$?" -eq "0" ]; then
        ...
        echo ""
        apt-get install -y golang-go python3 python3-pip python3-requests python3-pip gcc ruby php git wget bc curl netcat-traditional subversion openjdk-11-jre make automake gcc gzip rsync wget
