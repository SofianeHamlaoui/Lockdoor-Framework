...
intallationdirc = input("       \033[94mEnter Lockdoor's installation directory [" + intallationdirc + "]: \033[91m")
if not intallationdirc:
    intallationdirc = "/opt/sofiane/lockdoor"
Printspace()
Printspace()
# Choosing Verbose mode 
verbose = input("       \033[94mDo you want to use Verbose mode (output the installation process of tools) ? (Y/N) : \033[91m")
if verbose in no:
    null = " >/dev/null"
else:
    null = ""
